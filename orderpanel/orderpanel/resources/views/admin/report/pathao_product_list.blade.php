...
@section('title', 'Pathao Product List')
@section('content')
@push('css')
...
<div class="content-wrapper" style="min-height: 105px;">
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Pathao Product List</h1>
          </div>
          <!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"> Pathao Product List</li>
            </ol>
          </div>
          <!-- /.col -->
        </div>
